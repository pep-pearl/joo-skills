...
| --- | --- | --- |
| `repo-indexing` | 새 프로젝트를 AI 친화적으로 인덱싱할 때 | `AI_INDEX.md`, rules, header candidates |
| `repo-navigation` | 작업 시작 전 최소 파일을 고를 때 | read plan, read list, uncertainty |
| `ai-metadata-maintenance` | route/domain/API/state 변경 후 metadata 갱신 판단 | maintenance summary |
